      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: '100vh', marginLeft: '180px', overflow: 'visible', position: 'relative', zIndex: 2, background: 'rgba(10,26,47,0.85)', paddingLeft: '0', paddingRight: '0' }}>
        <main style={{ background: 'radial-gradient(ellipse at center, #0a1a2f 0%, #1a2747 100%)', minHeight: '100vh', color: '#fff', fontFamily: 'Segoe UI, Arial, sans-serif' }}>
          <section style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '4rem 1rem 2rem 1rem', background: 'rgba(10,26,47,0.95)' }}>
            <img src="/cyber-security-badge.png" alt="Cyber Security Certified" style={{ width: '120px', marginBottom: '1.5rem', borderRadius: '1rem', boxShadow: '0 0 32px #0ff8' }} />
            <h1 style={{ fontSize: '2.5rem', fontWeight: 800, letterSpacing: '2px', marginBottom: '0.5rem' }}>Cyber Security Certified</h1>
            <h2 style={{ fontSize: '1.3rem', fontWeight: 400, color: '#7ecfff', marginBottom: '1.5rem' }}>Protecting Digital Assets</h2>
            <p style={{ maxWidth: '600px', fontSize: '1.1rem', color: '#fff' }}>
              Master the art of defending digital assets against cyber threats. Our Cyber Security certification covers risk management, incident response, and the latest security technologies to keep organizations safe.
            </p>
          </section>
        </main>
      </div>
